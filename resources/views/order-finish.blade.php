                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                <div class="product-entry">
                                    ...
                                    <img src="{{$items->image}}" alt="" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                                    <div class="text">
                                        <h3>{{$items->name}} {{$items->type ?($items->type) : "" }}</h3>
                                        <span>Số lượng : {{$items->quantity}} </span>
                                        <p>@foreach($items->topping as $item)
                                                {{$item->name}},
                                            @endforeach</p>
                                        <span class="price" style="color: #000; font-size: 20px;">{{number_format($items->price)}}</span>
                                    </div>
                                </div>
                            </td>
                        </tr>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v64f9daad31f64f81be21cbef6184a5e31634941392597" integrity="sha512-gV/bogrUTVP2N3IzTDKzgP0Js1gg4fbwtYB6ftgLbKQu/V8yH2+lrKCfKHelh4SO3DPzKj4/glTO+tNJGDnb0A==" data-cf-beacon='{"rayId":"6b303b6f4c586e33","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.11.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>
